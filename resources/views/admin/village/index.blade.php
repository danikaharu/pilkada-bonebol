...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Beranda /</span> Kelurahan/Desa</h5>
        <div class="row">
            <div class="col-lg-12 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="card-title">Data Kelurahan/Desa</h5>
                        <h6 class="card-subtitle text-muted">Berikut data Kelurahan/Desa yang telah dimasukan</h6>
                        @can('create village')
                            <a href="{{ route('admin.village.create') }}" class="btn btn-primary my-4 text-white"><i
                                    class='bx bx-plus-circle'></i>
                                Tambah Kelurahan/Desa</a>
                        @endcan
